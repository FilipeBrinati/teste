...
function updateTexture(firstUse = false) {
  ...
  plane.material.map.offset.set(offsetFactor, offsetFactor)
}
...
function buildInterface() {
  ...
  var controls = new function () {
    ...
    this.onChangeOffsetFactor = function () {
      offsetFactor = this.offset;
      updateTexture();
    };
  ...
  gui.add(controls, 'offset', 1, 10)
    .name("Repeat Offset")
    .onChange(function (e) { controls.onChangeOffsetFactor() });
